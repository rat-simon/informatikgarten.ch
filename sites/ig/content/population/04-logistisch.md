...
![[04-logistisch.png]]
2. Nun brauchen wir die **normalisierte Restkapazität** - sozusagen die Restkapazität in Prozent. Das heisst, anstatt eine absolute Anzahl Wölfe berechnen wir **eine Zahl zwischen 1 für eine leere Insel mit 100% Restkapazität und 0 für eine total volle Insel mit 0% Restkapazität**. So können wir das Wachstum mit einer Multiplikation einfach skalieren, je nachdem wie viel Platz es auf der Insel noch gibt. Fügen Sie eine **neue Spalte zwischen den Spalten B und C** hinzu, die wir "**Restkapazitätsfaktor**" nennen, und lösen Sie folgende Aufgabe:
